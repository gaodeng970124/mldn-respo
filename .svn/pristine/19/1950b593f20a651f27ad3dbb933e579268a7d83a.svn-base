...
public class ResourceUtil {
    private static final String VALIDATIONS_BASENAME = "cn.mldn.resource.Validations";
    private static final String MESSAGES_BASENAME = "cn.mldn.resource.Messages";
    private static final String PAGES_BASENAME = "cn.mldn.resource.Pages";
