				...
				<div class="row">
					<c:forEach items="${allResource}" var="resource">	
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-4">
									<img src="upload/goods/${resource.photo}" style="width:100px;"/> 
								</div>
								<div class="col-md-4">
									<div class="row">
										<div class="col-md-12"><strong>${resource.title}</strong></div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<strong>
												<button class="btn btn-warning btn-xs" id="add-${resource.resid}">
