...
<%!
	...
	public static final String RESOURCE_LIST_URL = "pages/back/admin/resource/resource_list.action" ;
	...
	public static final String PLAN_ADD_URL = "pages/back/admin/plan/plan_add_pre.action" ;
	public static final String PLAN_PREPARE_LIST_URL = "pages/back/admin/plan/plan_prepare_list.jsp" ;
	public static final String PLAN_HISTORY_LIST_URL = "pages/back/admin/plan/plan_list.action" ;
